...
class TestModifyAddress(unittest.TestCase):
    ...
    def test_modify_address(self):
        ...
        data = {"address": {"default_address": 0, "consignee": "user", "tel": "1898976579464", "zipcode": "621000",
                            "country": "4044", "city": "0", "id": 0, "email": "98784564@qq.com", "address": "sdfsdfsd",
                            "province": "0", "district": "0", "mobile": ""}, "address_id": f"{self.address_id}",
                "session": self.res}
        # 获取预期结果
