...
class TestShoppingProcess(unittest.TestCase):
    ...
    def test_shopping_process(self):
        ...
        data = {"address": {"default_address": 0, "consignee": "郭仁捷", "tel": "18582361927", "zipcode": "656560",
                            "country": "1", "city": "271", "id": 0, "email": "1234@163.com", "address": "天府新谷",
                            "province": "24", "district": "2716", "mobile": ""}, "session": session}
